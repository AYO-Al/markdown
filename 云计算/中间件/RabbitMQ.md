...
![image-20230222164847181](../../.gitbook/assets/w8kgkx.png)

![image-20230222164918967](../../.gitbook/assets/w8ki6z.png)

![image-20230222164946334](../../.gitbook/assets/w8knr2.png)

![image-20230222164956222](../../.gitbook/assets/w8kn2k.png)

> RabbitMQ

![image-20230222165036067](../../.gitbook/assets/w8kmil.png)

![image-20230222165124659](../../.gitbook/assets/w8kk60.png)

![image-20230222165133285](../../.gitbook/assets/w8kn6e.png)

![image-20230222165150102](../../.gitbook/assets/w8ko8d.png)

> Apache RocketMQ

![image-20230222165218293](../../.gitbook/assets/w8kjpu.png)

![image-20230222165229337](../../.gitbook/assets/w8ki9q.png)

![image-20230222165238848](../../.gitbook/assets/w8kvcc.png)

![image-20230222165246312](../../.gitbook/assets/w8kr2z.png)

> kafka

![image-20230222165332271](../../.gitbook/assets/w8kwj1.png)

![image-20230222165349571](../../.gitbook/assets/w8krui.png)

![image-20230222165358855](../../.gitbook/assets/w8kuxk.png)

![image-20230222165412783](../../.gitbook/assets/w8kq4y.png)

> 总结

![image-20230222165702812](../../.gitbook/assets/w8kr20.png)

## 3.RabbitMQ高性能原因

![image-20230222165900312](../../.gitbook/assets/w8krgl.png)

> Erlang特点

![image-20230222170033009](../../.gitbook/assets/w8kzlu.png)

> 总结

![image-20230222170212200](../../.gitbook/assets/w8kzlr.png)
...
![image-20230222171814117](../../.gitbook/assets/w8kysz.png)

![image-20230222171853727](../../.gitbook/assets/w8kxl2.png)

![image-20230222171932748](../../.gitbook/assets/w8ky6c.png)

![image-20230222172034545](../../.gitbook/assets/w8l1g3.png)
...
![image-20230226144723491](../../.gitbook/assets/w8l7jh.png)

> Fanout Exchange

* 每个发送到Fanout Exchange的message都会分发到所有绑定的queue上去

![image-20230226144941870](../../.gitbook/assets/w8l8ry.png)
...
*   根据Routing key及通配规则，Topic Exchange将消息分发到目标Queue
    ...
    * Binding Key中的\*：匹配任意1个word
    ...
    ![image-20230226145631688](../../.gitbook/assets/w8l6j5.png)

> [RabbitMQ Simulator (tryrabbitmq.com)](http://tryrabbitmq.com/)可以在线实验Exchange规则

> 总结

![image-20230226150954374](../../.gitbook/assets/w8l6c6.png)

![image-20230226151015867](../../.gitbook/assets/w8lb61.png)

## 6.RabbitMQ快速安装

![image-20230226151326717](../../.gitbook/assets/w8lgdw.png)

> Windows安装

![image-20230226151440450](../../.gitbook/assets/w8lyqj.png)

![image-20230226151535108](../../.gitbook/assets/w8m026.png)

> Linux安装

* docker拉取镜像

![image-20230226151708341](../../.gitbook/assets/w8m0eh.png)

* 手动安装
  * 安装epel：yum install -y epel-release
  * 下载erlang：yum install -y erlang
  * 下载socat：yum install -y socat
  * 获取rpm包：wget https://github.com/rabbitmq/rabbitmq-server/releases/download/rabbitmq\_v3\_6\_15/rabbitmq-server-3.6.15-1.el6.noarch.rpm
  ...
  * 开启网页管理工具：rabbitmq-plugins enable rabbitmq\_management

## 7.网页端管理工具

![image-20230226151927028](../../.gitbook/assets/w8m58j.png)

![image-20230226152049370](../../.gitbook/assets/w8m2t9.png)

## 8.命令行工具上手

![image-20230226155056550](../../.gitbook/assets/w8m38y.png)

![image-20230226155142994](../../.gitbook/assets/w8mccn.png)

> 状态查看

* 查看状态：rabbitmqctl status
* 查看绑定：rabbitmqctl list\_bindings
* 查看channel：rabbitmqctl list\_channels
* 查看connection：rabbitmqctl list\_connections
* 查看消费者：rabbitmqctl list\_consumers
* 查看交换机：rabbitmqctl list\_exchanges

![image-20230226155510950](../../.gitbook/assets/w8mbev.png)

![image-20230226155526585](../../.gitbook/assets/w8mdpn.png)

![image-20230226155539538](../../.gitbook/assets/w8mcop.png)

![image-20230226155601753](../../.gitbook/assets/w8mak4.png)

![image-20230226155610752](../../.gitbook/assets/w8mlhh.png)

![image-20230226155836968](../../.gitbook/assets/w8mhlm.png)
...
![image-20230227092153458](../../.gitbook/assets/w8mjfz.png)

> 架构设计

![image-20230227092246665](../../.gitbook/assets/w8mlzt.png)

> 什么是微服务架构

![image-20230227092712108](../../.gitbook/assets/w8mhzu.png)

![image-20230227093021066](../../.gitbook/assets/w8mj1v.png)

![image-20230227093125366](../../.gitbook/assets/w8mirf.png)

![image-20230227093230854](../../.gitbook/assets/w8ms72.png)

![image-20230227093412380](../../.gitbook/assets/w8mtyi.png)

![image-20230227101750975](../../.gitbook/assets/w8mrwm.png)

![image-20230227101826778](../../.gitbook/assets/w8mpyl.png)
...
![image-20230227100718432](../../.gitbook/assets/w8mrjx.png)

![image-20230227100824329](../../.gitbook/assets/w8mrit.png)

## 11.保证消息可靠性

> 发送方

![image-20230228081256003](../../.gitbook/assets/w8mrj1.png)

> 消费方

![image-20230228081352702](../../.gitbook/assets/w8mtkj.png)

> RabbitMQ

![image-20230228081439255](../../.gitbook/assets/w8n0si.png)

### 11.1.发送端确认机制

![image-20230228081551897](../../.gitbook/assets/w8n0xs.png)
...
*   单条同步确认
    ...
    ![image-20230228082128561](../../.gitbook/assets/w8n1hg.png)
*   多条同步确认

    ![image-20230228082209562](../../.gitbook/assets/w8mznr.png)
*   异步确认机制

    ![image-20230228082353745](../../.gitbook/assets/w8n1nz.png)

### 11.2.消息返回机制

![image-20230228194255639](../../.gitbook/assets/w8myk1.png)

![image-20230228194449663](../../.gitbook/assets/w8n37k.png)

![image-20230228194526071](../../.gitbook/assets/w8n673.png)

### 11.3.消费端确认

![image-20230228194946791](../../.gitbook/assets/w8n422.png)

![image-20230228195020267](../../.gitbook/assets/w8n673_1.png)

![image-20230228195100671](../../.gitbook/assets/w8n8oi.png)

![image-20230228195142226](../../.gitbook/assets/w8n8gg.png)

### 11.4.消费端限流机制

![image-20230228195246755](../../.gitbook/assets/w8n7n3.png)

![image-20230228195331598](../../.gitbook/assets/w8nb8o.png)

![image-20230228195443831](../../.gitbook/assets/w8nct5.png)

![image-20230228195607563](../../.gitbook/assets/w8nbsg.png)

![image-20230228195642836](../../.gitbook/assets/w8nd5u.png)

### 11.5.消息过期机制

![image-20230228195758983](../../.gitbook/assets/w8nep8.png)

![image-20230228195842619](../../.gitbook/assets/w8nayn.png)

![image-20230228200004491](../../.gitbook/assets/w8nfxh.png)

### 11.6.死信队列

![image-20230228200137967](../../.gitbook/assets/w8nn9z.png)

![image-20230228200220708](../../.gitbook/assets/w8niw6.png)

![image-20230228200401202](../../.gitbook/assets/w8nowc.png)

![image-20230228200441631](../../.gitbook/assets/w8nn8o.png)
...
![image-20230228204615951](../../.gitbook/assets/w8nl8e.png)

> 集群搭建步骤

![image-20230228204704028](../../.gitbook/assets/w8nm25.png)

* 查看：cat /var/lib/rabbitmq/.erlang.cookie
  * 要求全部集群节点的erlang.cookie全部一样
* 加入集群：rabbitmqctl join\_cluster 主机名

### 12.2.RabbitMQ镜像队列

![](../../.gitbook/assets/qrzg52-0.png)
...
![](../../.gitbook/assets/s5l8np-0.png)

![image-20230301172229025](../../.gitbook/assets/shfuus-0.png)

![image-20230301224514094](../../.gitbook/assets/114quia-0.png)

![image-20230301224617231](../../.gitbook/assets/115be5m-0.png)

### 12.3.RabbitMQ实现高可用

> 客户端负载均衡

![image-20230301225025974](../../.gitbook/assets/117qy7k-0.png)

![image-20230301225218690](../../.gitbook/assets/118wfz1-0.png)

> 服务端负载均衡

![image-20230301225256801](../../.gitbook/assets/1194hw9-0.png)
...
* 配置HAProxy，使用四层代理模式
  *   配置文件目录：/etc/haproxy/haproxy.cfg
      ...
      ```
* 放开haproxy权限：setsebool -P haproxy\_connect\_any=1

### 12.4.HAProxy+Keepalived高可用

![image-20230301231803286](../../.gitbook/assets/12c3gw4-0.png)
...
![image-20230302131119412](../../.gitbook/assets/looy94-0.png)
...
![image-20230302131509273](../../.gitbook/assets/lqz1fu-0.png)

![image-20230302131538759](../../.gitbook/assets/lr573e-0.png)

![image-20230302131602775](../../.gitbook/assets/lrj1nb-0.png)

![image-20230302131633832](../../.gitbook/assets/lrpp5b-0.png)

> Federation设置方法

![image-20230302131717746](../../.gitbook/assets/ls7jnq-0.png)
...
![image-20230302132005545](../../.gitbook/assets/ltxegx-0.png)

![image-20230302132024031](../../.gitbook/assets/lu15fr-0.png)
...
![image-20230302132645493](../../.gitbook/assets/lxqlbm-0.png)
...
![image-20230302144202403](../../.gitbook/assets/nzb7nq-0.png)
...
![image-20230302164516924](../../.gitbook/assets/r7hr9c-0.png)
...
![image-20230303093900576](../../.gitbook/assets/fj3zld-0.png)

> RabbitMQ集群网络分区的意义

* 如果出现Rabbit01和Rabbit03网络不可连接，此时可以人为造成网络分区，保存部分集群正常运行

![image-20230303094222029](../../.gitbook/assets/fkzfcz-0.png)
...
![image-20230303095219505](../../.gitbook/assets/fqx8vy-0.png)

![image-20230303095229116](../../.gitbook/assets/fqz5v1-0.png)
...
* 使用rabbitmqctl cluster\_status命令
* 使用管控台查看
...
* 手动处理
  ...
  4. 关闭非信任区的节点：采用rabbitmqctl stop\_app命令，只关闭RabbitMQ应用，不会关闭ErLang虚拟机
  5. 启动非信任区的节点：rabbitmqctl start\_app
...
* 自动处理
  ...
  * 默认是ignore模式，不自动处理
  * 如要开启，配置rabbitmq.config中的cluster\_paritition\_handing参数
  * pause-minority
...
![image-20230303144023246](../../.gitbook/assets/ntj5j1-0.png)

![image-20230303144113687](../../.gitbook/assets/nu0zy8-0.png)

![image-20230303144353147](../../.gitbook/assets/nvg5jf-0.png)

![image-20230303144503169](../../.gitbook/assets/nwc9zj-0.png)
...
![image-20230303145011184](../../.gitbook/assets/nzd7sd-0.png)
...
![image-20230303150220033](../../.gitbook/assets/oudnq3-0.png)
...
![image-20230303150722155](../../.gitbook/assets/oxdkib-0.png)
...
![image-20230303150925024](../../.gitbook/assets/oyks1j-0.png)
