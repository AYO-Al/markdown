...
![image-20221011201343785](../../.gitbook/assets/w5p9w3.png)
...
![image-20221011204719285](../../.gitbook/assets/w5p7je.png)
...
![此处输入图片的描述](../../.gitbook/assets/zg57bf-0.png)

LInux的文件系统采用层级式的树状目录结构，再次结构中的最上层是根目录"/"，然后在此目录下创建其他目录

![img](../../.gitbook/assets/d0c50-linux2bfile2bsystem2bhierarchy.jpg)
...
![img](../../.gitbook/assets/zg5bay-0.png)
...
![image-20221015124503334](../../.gitbook/assets/w5pzjt.png)

![image-20221015130128183](../../.gitbook/assets/w5qnyn.png)

> 快捷键

![img](../../.gitbook/assets/zh326q-0.gif)
...
![image-20221015133233993](../../.gitbook/assets/w5qp50.png)
...
![image-20221018084102587](../../.gitbook/assets/w62nho.png)
...
![image-20221015140015413](../../.gitbook/assets/w60ag2.png)
...
* GNU/Linux 的文件有3种类型的时间戳：
  * _mtime_: 最后修改时间 (`ls -lt`)
  * _ctime_: 状态改变时间 (`ls -lc`)
  * _atime_: 最后访问时间 (`ls -lu`)
* 说明
  * _ctime_ 并非文件创建时间。
  * 修改一个文件会改变所有三类时间
  * 改变文件的访问权限或拥有者会改变文件的 _ctime_ 和 _atime_
  * 读文件会改变文件的 _atime_
...
![此处输入图片的描述](../../.gitbook/assets/zhwycg-0.png)
...
>
> -a<1或2> 除了显示原来的输出内容之外，还显示指令文件中没有相同栏位的行。 -e<字符串> 若\[文件1]与\[文件2]中找不到指定的栏位，则在输出中填入选项中的字符串。 -i或–igore-case 比较栏位内容时，忽略大小写的差异。 -o<格式> 按照指定的格式来显示结果。 -t<字符> 使用栏位的分隔字符。 -v<1或2> 跟-a相同，但是只显示文件中没有相同栏位的行。 -1<栏位> 连接\[文件1]指定的栏位。 -2<栏位> 连接\[文件2]指定的栏位。
...
![image-20221015174718906](../../.gitbook/assets/w60b2h.png)

![image-20221015195417711](../../.gitbook/assets/w60awn.png)
...
*   find 从指定目录向下递归地遍历各个子目录，将满足条件的文件或目录显示在终端
    ...
    * 选项
    ...
    ![image-20230203091421033](../../.gitbook/assets/w7iy01.png)
* locate 快速定位文件路径
...
*   **tar** 既可以压缩也可以解压也可以打包
    ...
    * -h:备份链接指向的源文件，而不是链接本身
    ...
    ![image-20221015213829708](../../.gitbook/assets/w60j1b.png)
...
*   ls -alh：查看文件所有者
    ...
    ![image-20221016122357350](../../.gitbook/assets/w60cvp.png)
...
![image-20221016123813256](../../.gitbook/assets/w60f4f.png)

![image-20221016125603779](../../.gitbook/assets/w60gh9.png)
...
![image-20221027153905429](../../.gitbook/assets/w64pih.png)
...
>
> <img src="../../.gitbook/assets/zigmrg-0.png" alt="实验楼" data-size="original">
>
> 每个目录的作用：
>
...
![image-20221016155400289](../../.gitbook/assets/w60dj2.png)

![image-20221016160245397](../../.gitbook/assets/w60kau.png)
...
4. 在使用at命令时，一定要保证atd进程的启动，可以使用相关指令来查看
   1.  ps -ef|grep atd
       ...
       ![image-20221016162601943](../../.gitbook/assets/w60kuj.png)

* at命令格式
  *   at \[选项] \[时间]

      ![image-20221016162802345](../../.gitbook/assets/w60pjb.png)
  * at指定时间的方法
...
3.  原理图
    ...
    ![image-20221016171020624](../../.gitbook/assets/w60m6g.png)
...
* 磁盘情况查询
  *   df -Th
      ...
      ![image-20221110151500045](../../.gitbook/assets/w6t15q.png)
...
*   常用命令
    ...
    ![image-20221016191126607](../../.gitbook/assets/w60zao.png)
...
* 如何增加一块硬盘
  1.  虚拟机添加硬盘
      ...
      ![image-20221016172824618](../../.gitbook/assets/w60qbu.png)
  2.  分区
...
​ ![image-20221016182734566](../../.gitbook/assets/w60ndt.png)

![image-20221016192043617](../../.gitbook/assets/w60z9a.png)

## 17.网络配置

![image-20221110155826263](../../.gitbook/assets/w6sw8h.png)

![image-20221110164222999](../../.gitbook/assets/w6svtl.png)

![image-20221016193432166](../../.gitbook/assets/w613ys.png)
...
![image-20221016194648695](../../.gitbook/assets/w612jv.png)
...
![image-20221016200310079](../../.gitbook/assets/w6163u.png)
...
![实验楼](../../.gitbook/assets/zjie2n-0.png)
...
![实验楼](../../.gitbook/assets/zjodhi-0.png)
...
![实验楼](../../.gitbook/assets/zkc30n-0.png)
...
*   选项
    ...
    * -9：表示强迫进程立即停止
    ...
    ![image-20221101092858018](../../.gitbook/assets/w67zw3.png)
...
>
>     ![image-20221020193150403](../../.gitbook/assets/w62qyx.png)
...
>
> <img src="../../.gitbook/assets/w62q8h.png" alt="image-20221020194708063" data-size="original">
...
![image-20221020204110065](../../.gitbook/assets/w62p5y.png)

![实验楼](../../.gitbook/assets/zkwn6t-0.png)
...
![image-20221020213504167](../../.gitbook/assets/w631ke.png)
...
* 更新所有软件命令：**yum update**
* 仅安装指定的软件命令：**yum install \<package\_name>**
* 仅更新指定的软件命令：**yum update \<package\_name>**
* 列出所有可安裝的软件清单命令：**yum list**
* 删除软件包命令：**yum remove \<package\_name>**
* 查找软件包命令：**yum search**
* 清除缓存命令:
...
* 数组
  ...
  * 读取数组元素值：${数组名\[下标]}
  * 使用 **@** 符号可以获取数组中的所有元素：echo ${array\_name\[@]}
* 多行注释
  * 单行注释：#
  * 多行注释：:<\<! 注释内容 !
...
![image-20221022104318168](../../.gitbook/assets/w63263.png)
...
![image-20221022121113730](../../.gitbook/assets/w62wqz.png) ![image-20221022122717673](../../.gitbook/assets/w639fa.png)
...
![image-20221022123042487](../../.gitbook/assets/w63akv.png)
...
![image-20221022200152419](../../.gitbook/assets/w63atn.png)
...
![image-20230207162624689](../../.gitbook/assets/w7j9f4.png)
...
![image-20221023165649718](../../.gitbook/assets/w63nth.png)

> 也可以把日志的轮替规则写到/etc/logrotate.d文件夹中
>
> <img src="../../.gitbook/assets/w63xu4.png" alt="image-20221023170125701" data-size="original">

> 日志轮替机制原理

日志轮替之所以可以在指定的时间备份日志，是依赖系统定时任务。在/etc/cron.daily/目录，就会发现这个目录中石油logrotate文件，logrotate通过这个文件依赖定时任务执行的

![image-20221023170847213](../../.gitbook/assets/w63xgt.png)
...
>
> 1. kernel文件：vmlinuz-3.10.0-957.el7.x86\_64
> 2. initrd文件：initramfs-3.10.0-957.el7.x86\_64.img

> 制作Linux思路分析

![image-20221023192907698](../../.gitbook/assets/w642ep.png)
...
![image-20221024193517355](../../.gitbook/assets/w64bsb.png)
...
![image-20221024195413963](../../.gitbook/assets/w64i6y.png)
...
| `.`         | **匹配除  之外的任何单个字符**。要匹配包括  在内的任何字符，请使用类似 `(.｜\n)` 的模式。                                                                                                                                                                 |
...
![pic](../../.gitbook/assets/zlur13-0.png)
...
![image-20230203092436878](../../.gitbook/assets/w7j2zb.png)
