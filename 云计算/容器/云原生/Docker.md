...
*   Namespace命名空间主要用于资源的隔离
    ...
    ![image-20230429143131666](../../../.gitbook/assets/Docker_time_1.png)
* Cgroup就复制资源管理控制作用，比如进程组使用CPU/MEM的限制，进程组的优先级控制，进程组的挂起和恢复等待

![image-20230324152331200](../../../.gitbook/assets/Docker_time_2.png)
...
![image-20230324154054828](../../../.gitbook/assets/Docker_time_3.png)
...
![image-20230430153859635](../../../.gitbook/assets/Docker_time_4.png)
...
![image-20230324164924641](../../../.gitbook/assets/Docker_time_5.png)
...
![image-20230324194056505](../../../.gitbook/assets/Docker_time_6.png)
...
![image-20230429145302236](../../../.gitbook/assets/Docker_time_7.png)
...
![image-20230324200855390](../../../.gitbook/assets/Docker_time_8.png)
...
Shell形式：RUN ，这种形式会在一个shell中运行命令，shell的默认值是/bin/sh -c在Linux上或者cmd /S /C在Windows上12。Shell形式可以使用\ (反斜杠)来把一个RUN命令分成多行。\
...
![image-20230325153615317](../../../.gitbook/assets/Docker_time_9.png)

使用ENV和ARG的注意事项有：

* ENV和ARG都可以使用两种格式，一种是 ，一种是=。
...
![image-20230325205456849](../../../.gitbook/assets/Docker_time_10.png)
...
![image-20230501103900820](../../../.gitbook/assets/Docker_time_11.png)

### None

* 拥有自己的Network Namespace，但是并不为Docker容器进行任何网络配置

![image-20230501103928977](../../../.gitbook/assets/Docker_time_12.png)

### Host

* 让容器和已经存在的容器共享一个Network Namespace。容器不会虚拟自己的网卡、配置自己的IP等，而是使用宿主机的IP和端口进行通信

![image-20230501104356987](../../../.gitbook/assets/Docker_time_13.png)

### 联合网络

* 指定新创建的容器和以及存在的容器共享一个Network Namespace，而不是与宿主机共享。新创建的容器不会创建自己的网卡，而是使用宿主机的IP和端口进行通信

![image-20230501105558406](../../../.gitbook/assets/Docker_time_14.png)
...
![image-20230501114211676](../../../.gitbook/assets/Docker_time_15.png)

> Docker的缺点

![image-20230501114234238](../../../.gitbook/assets/Docker_time_16.png)
