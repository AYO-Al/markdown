...
gitRepo卷本质上也是一个emptyDir卷，它通过克隆Git仓库并在pod启动时(在创建容器之前)检出特定版本来填充数据，如下图所示：![](../../../.gitbook/assets/第五章：卷-将磁盘挂载到容器_time_1.png)
...
在pod中使用PersistentVolume(持久卷，简称PV)要比使用常规的pod卷复杂一些。![](../../../.gitbook/assets/第五章：卷-将磁盘挂载到容器_time_2.png)\
