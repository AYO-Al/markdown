...
![image-20230308162532755](../../.gitbook/assets/shell脚本编程_time_1.png)
...
![image-20230308163504414](../../.gitbook/assets/shell脚本编程_time_2.png)
...
![image-20230308224820492](../../.gitbook/assets/shell脚本编程_time_3.png)

![image-20230611132622416](../../.gitbook/assets/shell脚本编程_time_4.png)
...
![image-20230308231411980](../../.gitbook/assets/shell脚本编程_time_5.png)

![image-20230308231455002](../../.gitbook/assets/shell脚本编程_time_6.png)

![image-20230308231517582](../../.gitbook/assets/shell脚本编程_time_7.png)
...
![image-20230308233159954](../../.gitbook/assets/shell脚本编程_time_8.png)

![image-20230308233208472](../../.gitbook/assets/shell脚本编程_time_9.png)
...
![image-20230611132729320](../../.gitbook/assets/shell脚本编程_time_10.png)
...
![image-20230611134530174](../../.gitbook/assets/shell脚本编程_time_11.png)
...
![image-20230611135021807](../../.gitbook/assets/shell脚本编程_time_12.png)

![image-20230611135353859](../../.gitbook/assets/shell脚本编程_time_13.png)

![image-20230611135445183](../../.gitbook/assets/shell脚本编程_time_14.png)

![image-20230611135641845](../../.gitbook/assets/shell脚本编程_time_15.png)

![image-20230611135800215](../../.gitbook/assets/shell脚本编程_time_16.png)

![image-20230611135937868](../../.gitbook/assets/shell脚本编程_time_17.png)
...
![image-20230309212128232](../../.gitbook/assets/shell脚本编程_time_18.png)

![image-20230309212159695](../../.gitbook/assets/shell脚本编程_time_19.png)

> 如何调用函数

* 直接使用函数名调用，可以想象为Shell中的一条命令
* 函数内部可以直接使用参数$1、$2.....$n
* 调用函数：function\_name $1 $2
...
![image-20230309214330074](../../.gitbook/assets/shell脚本编程_time_20.png)
...
![image-20230611130438172](../../.gitbook/assets/shell脚本编程_time_21.png)
...
![image-20230611134351868](../../.gitbook/assets/shell脚本编程_time_22.png)
...
![image-20230310142459411](../../.gitbook/assets/shell脚本编程_time_23.png)

![image-20230310143156080](../../.gitbook/assets/shell脚本编程_time_24.png)

![image-20230310143143153](../../.gitbook/assets/shell脚本编程_time_25.png)

![image-20230310143410195](../../.gitbook/assets/shell脚本编程_time_26.png)

![image-20230310144310716](../../.gitbook/assets/shell脚本编程_time_27.png)
...
![image-20230310145813573](../../.gitbook/assets/shell脚本编程_time_28.png)

> which

![image-20230310145917084](../../.gitbook/assets/shell脚本编程_time_29.png)

> 总结

![image-20230310145953509](../../.gitbook/assets/shell脚本编程_time_30.png)
...
![image-20230310152120919](../../.gitbook/assets/shell脚本编程_time_31.png)

![image-20230310152345676](../../.gitbook/assets/shell脚本编程_time_32.png)
...
![image-20230310155509432](../../.gitbook/assets/shell脚本编程_time_33.png)
...
![image-20230310161058216](../../.gitbook/assets/shell脚本编程_time_34.png)

### 5.4 5.4.sed中的编辑命令

![image-20230310164525336](../../.gitbook/assets/shell脚本编程_time_35.png)

![image-20230310164557539](../../.gitbook/assets/shell脚本编程_time_36.png)

![image-20230310211551821](../../.gitbook/assets/shell脚本编程_time_37.png)
...
![img](../../.gitbook/assets/shell脚本编程_time_38.png)
...
![image-20230311144614613](../../.gitbook/assets/shell脚本编程_time_39.png)

![image-20230311151835869](../../.gitbook/assets/shell脚本编程_time_40.png)

### 6.3 6.3.awk格式化输出值printf

> printf的格式说明符

![image-20230311152600845](../../.gitbook/assets/shell脚本编程_time_41.png)

![image-20230311152633009](../../.gitbook/assets/shell脚本编程_time_42.png)
...
![image-20230311160147417](../../.gitbook/assets/shell脚本编程_time_43.png)
...
![image-20230311161853581](../../.gitbook/assets/shell脚本编程_time_44.png)

![image-20230311162016824](../../.gitbook/assets/shell脚本编程_time_45.png)

### 6.5 6.5.awk中表达式的用法

![image-20230311162231078](../../.gitbook/assets/shell脚本编程_time_46.png)
...
![image-20230311164031156](../../.gitbook/assets/shell脚本编程_time_47.png)

![image-20230311164449587](../../.gitbook/assets/shell脚本编程_time_48.png)

> 分别用三种循环写1加到100

![image-20230311171400623](../../.gitbook/assets/shell脚本编程_time_49.png)

![image-20230311171531138](../../.gitbook/assets/shell脚本编程_time_50.png)

![image-20230311171601081](../../.gitbook/assets/shell脚本编程_time_51.png)

### 6.7 6.7.awk中的字符串函数

![image-20230311172506374](../../.gitbook/assets/shell脚本编程_time_52.png)

![image-20230311172618086](../../.gitbook/assets/shell脚本编程_time_53.png)
...
![image-20230312105219498](../../.gitbook/assets/shell脚本编程_time_54.png)
...
* 语法格式：array\_name\[index]=value
* 删除：delete array\_name\[index]；不指定索引则删除整个数组
* 乱序遍历：for(var in array\_name){action};var是array\_name的索引
* awk数组的长度的语法格式是：length(array\_name)，其中array\_name是数组的名称。这个函数可以返回数组的元素个数，也可以返回字符串的字符个数。
* awk数组的排序的语法格式是：asort(array\_name)或asorti(array\_name)，其中array\_name是数组的名称。这两个函数可以对数组进行排序，asort是按照数组的元素值排序，asorti是按照数组的索引排序。排序后，原数组的顺序会被改变，如果不想改变原数组，可以使用另一个数组来接收排序的结果。
...
![image-20230312173308855](../../.gitbook/assets/shell脚本编程_time_55.png)

![image-20230312194226585](../../.gitbook/assets/shell脚本编程_time_56.png)
