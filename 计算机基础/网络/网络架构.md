...
![image-20221113224049765](./image/w6tuhd.png)
...
- 根据路由表选择最佳路径
  ...
  ![image-20221113224818226](./image/w6tp8h.png)
...
![image-20221113225213399](./image/w6turu.png)
...
![image-20221113225948105](./image/w6ttt1.png)
...
![image-20221117193826913](./image/w6vygn.png)
...
![image-20221117200928906](./image/w6w0x7.png)
...
- 虚接口
  ...
  ![image-20221117204746517](./image/w6vzj8.png)
...
![image-20221117210529084](./image/w6vv8p.png)
...
![image-20221120133649342](./image/w6w5a3.png)
...
![image-20221120140926975](./image/w6w8ul.png)
...
![image-20221121103823822](./image/w6xes1.png)

> 没有配置抢占机制重新恢复的端口不会重新成为活跃端口，配置抢占机制只需要在主动端配置即可
>
> 切换回活动状态需要经过抢占延时的时间

![image-20221121104323161](./image/w6xi01.png)
...
![image-20221120144450547](./image/w6x10t.png)
...
![image-20221120163747242](./image/w6wzk6.png)
...
![image-20221120164320319](./image/w6wx3k.png)
...
![image-20221120164626402](./image/w6x2cj.png)
...
- 网桥ID(BID)
  ...
  ![image-20221120165145991](./image/w6x5if.png)
...
- 选择根端口的依据
  ...
  - 端口标识最小
    ...
    ![image-20221120165645765](./image/w6xbku.png)
...
![image-20221120171746140](./image/w6xb8t.png)
...
![image-20221120172529151](./image/w6x84e.png)
...
- 交换机端口的5中状态
  ...
  ![image-20221120172939738](./image/w6x6ty.png)

**交换机从不稳定状态到稳定状态，这个过程叫做收敛。**

![image-20221130160531664](./image/w784vt.png)
...
- STP的3中计时器
  ...
  - 最大老化时间：超过20s还没更新数据，会删除旧数据
   ...
   ![image-20221120173425192](./image/w6xd4x.png)
...
![image-20221121202944821](./image/w6xh6s.png)
...
![image-20221205101927251](./image/w6q5dl.png)
...
![image-20221121221408117](./image/w6xd2l.png)
...
![image-20221122221944001](./image/w6xf3i.png)

> 工作原理

![image-20221122223636681](./image/w6xqcy.png)

![image-20221122222216772](./image/w6xk3c.png)

![image-20221122222338036](./image/w6xksc.png)
...
![image-20221123200442574](./image/w6xmwn.png)
...
![image-20221123222217047](./image/w6xp0d.png)
...
![image-20221123223447150](./image/w6xqvb.png)
...
![image-20221124165922317](./image/w6xssb.png)
...
- VLSM允许把子网继续划分为更小的子网
  ...
  ![image-20221124172755171](./image/w6xxri.png)
...
![image-20221124212431559](./image/w6xwiz.png)
...
![image-20221125202822428](./image/w6xw73.png)
...
![image-20221125203148450](./image/w6xxjr.png)
...
![image-20221125203403144](./image/w6y19u.png)
...
![image-20221125203522625](./image/w6y52v.png)



- 盒式设备堆叠后形成的虚拟设备相当于一台框式分布式设备，堆叠中的Master相当于虚拟设备的主用主控板，Slave设备相当于备用主控板

![image-20221125203715173](./image/w6y2w6.png)

- **IRF堆叠维护**的主要功能是监控成员设备的加入和离开，并随时收集新的拓扑，维护现有拓扑

![image-20221125203835424](./image/w6y3co.png)
...
- 配置设备编号
  ...
  ![image-20221125210253311](./image/w6y0ji.png)
...
![image-20221125211152772](./image/w6y2ws.png)
...
![image-20221125212947924](./image/w6y4fp.png)
...
![image-20221125213241680](./image/w6yaag.png)
...
![image-20221125213320877](./image/w6yai9.png)

![image-20221125213513349](./image/w6ye0p.png)
...
- 显示bfd信息
  ...
  ![image-20221125214114635](./image/w6ybxk.png)
...
![image-20221125215018574](./image/w6ybo5.png)
...
![image-20221125221053392](./image/w6yab1.png)

![image-20221125220643719](./image/w6y9ph.png)
...
![image-20221125222719622](./image/w7739l.png)
...
![image-20221125223300238](./image/w77594.png)
...
![image-20221125223344726](./image/w77199.png)
...
![image-20221125223430533](./image/w7723n.png)
