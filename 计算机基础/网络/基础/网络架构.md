...
![image-20221113224049765](../../../.gitbook/assets/w6tuhd.png)
...
*   根据路由表选择最佳路径
    ...
    * 每条路由表记录指明了：到达某个子网或主机应从路由器的那个物理端口发送，通过此端口可到达该路径的下一个路由器的地址(或直接相连网络中的目标主机地址)
    ...
    ![image-20221113224818226](../../../.gitbook/assets/w6tp8h.png)
...
![image-20221113225213399](../../../.gitbook/assets/w6turu.png)
...
![image-20221113225948105](../../../.gitbook/assets/w6ttt1.png)
...
![image-20221117193826913](../../../.gitbook/assets/w6vygn.png)
...
![image-20221117200928906](../../../.gitbook/assets/w6w0x7.png)
...
*   虚接口
    ...
    * 使用vlanif(vlan接口)实现vlan间路由
    ...
    ![image-20221117204746517](../../../.gitbook/assets/w6vzj8.png)
...
![image-20221117210529084](../../../.gitbook/assets/w6vv8p.png)
...
![image-20221120133649342](../../../.gitbook/assets/w6w5a3.png)
...
![image-20221120140926975](../../../.gitbook/assets/w6w8ul.png)
...
![](../../../.gitbook/assets/w6w2q9.png)

> 优先级别底的设备为主动端

![image-20221121103823822](../../../.gitbook/assets/w6xes1.png)

> 没有配置抢占机制重新恢复的端口不会重新成为活跃端口，配置抢占机制只需要在主动端配置即可
>
> 切换回活动状态需要经过抢占延时的时间

![image-20221121104323161](../../../.gitbook/assets/w6xi01.png)
...
![image-20221120144450547](../../../.gitbook/assets/w6x10t.png)
...
![image-20221120163747242](../../../.gitbook/assets/w6wzk6.png)
...
![image-20221120164320319](../../../.gitbook/assets/w6wx3k.png)
...
![image-20221120164626402](../../../.gitbook/assets/w6x2cj.png)
...
*   网桥ID(BID)
    ...
    * 交换机之间选择BID值最小的交换机作为网络中的根网桥
    ...
    ![image-20221120165145991](../../../.gitbook/assets/w6x5if.png)
...
* 选择根端口的依据
  ...
  *   端口标识最小
      ...
      * 端口优先级可配置，默认值为128
      ...
      ![image-20221120165645765](../../../.gitbook/assets/w6xbku.png)
...
![image-20221120171746140](../../../.gitbook/assets/w6xb8t.png)
...
![image-20221120172529151](../../../.gitbook/assets/w6x84e.png)
...
*   交换机端口的5中状态
    ...
    ![image-20221120172939738](../../../.gitbook/assets/w6x6ty.png)

**交换机从不稳定状态到稳定状态，这个过程叫做收敛。**

![image-20221130160531664](../../../.gitbook/assets/w784vt.png)
...
*   STP的3中计时器
    ...
    * 最大老化时间：超过20s还没更新数据，会删除旧数据
    ...
    ![image-20221120173425192](../../../.gitbook/assets/w6xd4x.png)
...
![image-20221121202944821](../../../.gitbook/assets/w6xh6s.png)
...
![image-20221205101927251](../../../.gitbook/assets/w6q5dl.png)
...
![image-20221121221408117](../../../.gitbook/assets/w6xd2l.png)
...
![image-20221122221944001](../../../.gitbook/assets/w6xf3i.png)

> 工作原理

![image-20221122223636681](../../../.gitbook/assets/w6xqcy.png)

![image-20221122222216772](../../../.gitbook/assets/w6xk3c.png)

![image-20221122222338036](../../../.gitbook/assets/w6xksc.png)
...
![image-20221123200442574](../../../.gitbook/assets/w6xmwn.png)
...
![image-20221123222217047](../../../.gitbook/assets/w6xp0d.png)
...
![image-20221123223447150](../../../.gitbook/assets/w6xqvb.png)
...
![](../../../.gitbook/assets/w6xsnn.png)

![image-20221124165922317](../../../.gitbook/assets/w6xssb.png)
...
*   VLSM允许把子网继续划分为更小的子网
    ...
    ![image-20221124172755171](../../../.gitbook/assets/w6xxri.png)
...
![image-20221124212431559](../../../.gitbook/assets/w6xwiz.png)
...
![image-20221125202822428](../../../.gitbook/assets/w6xw73.png)
...
![image-20221125203148450](../../../.gitbook/assets/w6xxjr.png)

* IRF堆叠物理拓扑有两种---链式拓扑和**环形拓扑**
* 环形拓扑具有较高的可靠性

![image-20221125203403144](../../../.gitbook/assets/w6y19u.png)

* 堆叠中的每台设备都通过和自己直接相邻的其他成员设备之间交互Hello报文来收集整个堆叠的拓扑关系
* 拓扑收集完成后，会进入角色选举阶段，确定成员设备角色

![image-20221125203522625](../../../.gitbook/assets/w6y52v.png)

* 盒式设备堆叠后形成的虚拟设备相当于一台框式分布式设备，堆叠中的Master相当于虚拟设备的主用主控板，Slave设备相当于备用主控板

![image-20221125203715173](../../../.gitbook/assets/w6y2w6.png)

* **IRF堆叠维护**的主要功能是监控成员设备的加入和离开，并随时收集新的拓扑，维护现有拓扑

![image-20221125203835424](../../../.gitbook/assets/w6y3co.png)
...
*   配置设备编号
    ...
    ![image-20221125210253311](../../../.gitbook/assets/w6y0ji.png)
...
![image-20221125211152772](../../../.gitbook/assets/w6y2ws.png)
...
![image-20221125212947924](../../../.gitbook/assets/w6y4fp.png)
...
![image-20221125213241680](../../../.gitbook/assets/w6yaag.png)

> BFD会话建立方式和检测机制

* 端口号为3784

![image-20221125213320877](../../../.gitbook/assets/w6yai9.png)

![image-20221125213513349](../../../.gitbook/assets/w6ye0p.png)
...
*   显示bfd信息
    ...
    ![image-20221125214114635](../../../.gitbook/assets/w6ybxk.png)
...
![image-20221125215018574](../../../.gitbook/assets/w6ybo5.png)
...
![image-20221125221053392](../../../.gitbook/assets/w6yab1.png)

![image-20221125220643719](../../../.gitbook/assets/w6y9ph.png)
...
![image-20221125222719622](../../../.gitbook/assets/w7739l.png)
...
![image-20221125223300238](../../../.gitbook/assets/w77594.png)
...
![image-20221125223344726](../../../.gitbook/assets/w77199.png)

> 配线架

![image-20221125223430533](../../../.gitbook/assets/w7723n.png)
