...
* 可以在文件头写#encoding=gbk等修改python默认的编码格式或者# -_- coding: UTF-8 -_-修改
* 若文件中出现与编码格式不一致的字符时python解释器就会报错![](../../.gitbook/assets/263)
...
>
> 4、\_ \_ object\_ \_ #**内建方法，用户不要这样定义**
...
* ·当字符串中包含换行、回车，水平制表符或退格等无法直接表示的特殊字符时，也可以使用转义字符当字符串中包含换行、回车，水平制表符或退格等无法直接表示的特殊字符时，也可以使用转义字符![转义字符](../../.gitbook/assets/36)

### 7 注释

* Python 解释器在执行代码时会忽略注释，不做任何处理。
* 注释最大的作用就是提高代码的可读性![](../../.gitbook/assets/56)
...
* 变量：一般值改变后内存地址随着改变![](../../.gitbook/assets/44)
* 局部变量和全局变量![](../../.gitbook/assets/201)
...
* 整数类型：![](../../.gitbook/assets/46)
* 浮点类型：
* ![](../../.gitbook/assets/48)
* 布尔类型：![](../../.gitbook/assets/51)
* 字符串类型：![](../../.gitbook/assets/53)

#### 11.1 数据类型转换

* 数据类型转化事项：![](../../.gitbook/assets/58)
...
* 算术运算符：![](../../.gitbook/assets/60)
  * 整除一正一负向下取整
* 赋值运算符：![](../../.gitbook/assets/63)
  * python没有自增自减运算符，自增自减用+=、-+实现
* 比较运算符：![](../../.gitbook/assets/65)
* 布尔运算符：![](../../.gitbook/assets/67)
* 位运算符：![](../../.gitbook/assets/69)
*   海象运算符
...
* break语句
  * 基础语法：![](../../.gitbook/assets/88)
* continue语句：
  * 基础语法：![](../../.gitbook/assets/90)
* else语句：
  * 基础语法：![](../../.gitbook/assets/92)
...
* 获取列表的多个元素(切片)![](../../.gitbook/assets/103)
  * 切片会产生新的列表
...
* 以键值对的方式无序存储数据![](../../.gitbook/assets/114)
* 把key进过哈希函数计算得出位置
* key要求为不可变序列
* key不可重复
...
*   字典元素的获取![](../../.gitbook/assets/118)
    ...
    #99
    ```
* key的判断、元素删除、元素新增![](../../.gitbook/assets/123)![](../../.gitbook/assets/127)
*   获取字典视图![](../../.gitbook/assets/129)
...
* 元组的创建![](../../.gitbook/assets/137)
  * 第一种方式可以省略小括号
  * 第三种方式如果省略逗号，会被认为是元素原来的类型
* 为什么要把元组设计成不可变序列？![](../../.gitbook/assets/139)
*   遍历元组：
...
* 集合是没有value的字典![](../../.gitbook/assets/141)

#### 18.1 集合的基本操作

* 集合的创建![](../../.gitbook/assets/145)
  * 集合的元素不能重复
  * 空集合创建只能用内置函数进行设置
*   集合的判断，新增，删除![](../../.gitbook/assets/147)
...
* 基本概述![](../../.gitbook/assets/165)![](https://note.youdao.com/yws/public/resource/92933d878935240680c00793fc3e404c/xmlnote/WEBRESOURCE5abc5c09aedb97e3b64e9ad9e6e7f367/167)
  * pycharm中对字符串的驻留机制进行了优化，只要是字符串都可以驻留
* 驻留机制优缺点![](../../.gitbook/assets/169)

#### 20.2 字符串的操作

*   字符串的查询![](../../.gitbook/assets/171)
...
* 如果一个函数的函数体调用了函数本身，这个函数就被称为递归函数![](../../.gitbook/assets/203)
...
* 被动掉坑类型(try-expect)![](../../.gitbook/assets/205)
  * 当存在多个expect结构时应该按照先子类再父类的顺序捕获异常，为避免遗漏可能出现的异常，可以在最后加BaseException
* try-except-else:![](../../.gitbook/assets/207)
* try-except-else-finally:![](../../.gitbook/assets/209)
* python常见的BUG类型![](../../.gitbook/assets/211)
* traceback模块![](../../.gitbook/assets/95f72949-999a-45a9-b7a6-ab1ed86729ec-10865085.jpg)
  * 可以把异常打印在日记文件中
*   手动抛出异常
...
* 创建python类![](../../.gitbook/assets/217)
  * 类之外的叫函数，类里面的叫方法
  * 类属性，类方法，静态方法都可以直接类名.属性名调用，不需要创建对象
* 对象的创建![](../../.gitbook/assets/4ff3f4b8-f99b-4ed7-a280-25824e27668f-10865085.jpg)
*   动态绑定属性和方法

    > 在python类中，可以使用\_\_slots\_\_变量限制实例对象的属性和方法
    >
...
![](../../.gitbook/assets/7f52b4a2-4000-4d98-bdfb-841a94e252c5-10865085.jpg) ![](../../.gitbook/assets/1e4b79bf-1b2a-4a27-81e2-260e9128f9de-10865085.jpg)
...
![](../../.gitbook/assets/10f3d02a-8fab-4fe5-842f-a0b348c68030-10865085.jpg)
...
* python没有专门的封装关键字，所以在属性名前用\_\_表示私有
...
![](../../.gitbook/assets/b24237eb-e598-4929-b307-2f46a04faff8-10865085.jpg)
...
* 方法重写![](../../.gitbook/assets/4a859c27-d005-490e-a579-a7ebe5855fec-10865085.jpg)

#### 24.3 object类

![](../../.gitbook/assets/9d810dd3-343c-4c97-ba30-5c5a642fc593-10865085.jpg)

* object类特殊的方法和属性![](../../.gitbook/assets/7e1825fd-7b83-4cd4-bfdc-b94b7b343f85-10865085.jpg)
...
* **new\_\_与\_\_init**(new在前)![](../../.gitbook/assets/239)

#### 24,4 多态

![](../../.gitbook/assets/ed1350e8-172c-4e16-b87b-69cbd36b3a4e-10865085.jpg)

* 静态语言和动态语言关于多态的区别![](../../.gitbook/assets/a058616e-02dc-4b10-804a-0915d6884d0a-10865085.jpg)
...
* 模块基础![](../../.gitbook/assets/250)
* 创建与导入模块![](../../.gitbook/assets/260)
  * 使用import时只能接包名和模块名，from...import可以导入包，模块，变量
  * 同一目录下直接导入![](../../.gitbook/assets/6c52085f-01eb-45b7-88db-a36a459ccb97-10865085.jpg)
    * from post\_packaging.method import \*
  * 不同目录下导入![](../../.gitbook/assets/bb9bfc02-7ab2-4aed-99c2-9e2c0f1b5b5b-10865085.jpg)
* python包![](../../.gitbook/assets/b3454f8f-b992-4186-9841-4c5b9a4a231c-10865085.jpg)

#### 26.1 主程序运行

![](../../.gitbook/assets/7c456333-d523-488f-b21d-0c82d7e2a41f-10865085.jpg)

#### 26.2 python常用模块

![](../../.gitbook/assets/9ce1b8ff-7aba-4b03-a084-f5a4289416e4-10865085.jpg)

#### 26.3 模块总结

![](../../.gitbook/assets/7e6f495b-d999-40d5-84ae-b0d14dff6a3e-10865085.jpg)

### 27 python文件操作

*   文件的读写![](../../.gitbook/assets/265)![](../../.gitbook/assets/451ae177-1c4d-4719-abe1-32ed85fadf4c-10865085.jpg)

    ```
    file=open(file,mode='r',encoding='gbk')
    ```
* 常用文件处理方式![](../../.gitbook/assets/f1057def-0750-4096-9874-a15e8a27d233-10865085.jpg)
* 文件常用方法![](../../.gitbook/assets/e7e99cd0-a648-4c6e-a9e2-e7f0c5630773-10865085.jpg)
  * 文件对象调用完一定要关闭
* with语句![](../../.gitbook/assets/99cc8d63-d3b3-44c1-89f2-3ba9b386a882-10865085.jpg)
...
![](../../.gitbook/assets/f9a0af3d-d69b-460c-91d1-8fcc7ac28422-10865085.jpg)

* 操作目录的方法![](../../.gitbook/assets/e2c3e023-419f-4f4c-b544-14aa2a395226-10865085.jpg)
  * os.walk()会把所有子目录和文件遍历出来
* os.path操作目录常用函数![](../../.gitbook/assets/d2aba294-050a-4c60-9df0-108d5e551685-10865085.jpg)
...
*   装饰器的一个关键特性是，它们在被装饰的函数定义之后立即运行
    ...
    ![](../../.gitbook/assets/282)
* 作用：再不改变原有函数调用下，给函数增加新功能![](../../.gitbook/assets/843dc11f-ab8a-495d-9f6c-edd8bb66209a-10865085.jpg)
* 被装饰函数的参数问题![](../../.gitbook/assets/285)
...
*   装饰器参数问题
    ...
    ```
* 一个函数可被多个装饰器装饰![](../../.gitbook/assets/287)
* 通用装饰器写法![](../../.gitbook/assets/289)

### 32 迭代器

* 迭代器基本概念![](../../.gitbook/assets/291)![](../../.gitbook/assets/301)
  * 迭代器的特点
    1. 只能向前不能反复
    2. 特别节省内存
    3. 惰性机制
...
* event\_loop事件循环:程序开启一个无限循环，程序员会把一些函数注册到事件循环上。当满足事件发生的时候，调用相应的协程函数
...
>
> 而session.cookie\_jar.filter\_cookies("https://segmentfault.com")会一直保留这个网站的所有设置cookies，含有我们在会话时设置的cookie，并且会根据响应修改更新cookie。这个才是我们需要的
>
