...
**GORM 允许缓存准备好的语句以提高性能，详情查看**[**performance**](/broken/pages/VGsYch1h8ROOUIP3lxsf)
...
生成 `SQL` 及其参数但不执行，可用于准备或测试生成的 SQL，详情请查看[session](/broken/pages/JTqPcFokuxln1MoLuaAU)
