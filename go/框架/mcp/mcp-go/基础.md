...
| 参数     | 类型              | 必需 | 描述                                    |
| ------ | --------------- | -- | ------------------------------------- |
| `name` | `string`        | ✓  | ​**​工具名称​**​（唯一标识符，如 "search\_users"） |
...
func main() {
	...
	s := server.NewMCPServer(
		"HTTP Demo",
		"1.0.0",
		server.WithToolCapabilities(true), // 启用工具端点
	)
...
func helloHandler(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	name, err := request.RequireString("names")
	if err != nil {
...
/**
curl -X POST http://localhost:8080/mcp/tools/call   -H "Content-Type: application/json"   -d '{
    "jsonrpc": "2.0",
      "params": {
        "name": "hello_world","arguments":{"names":"Alice"}
      },
    "id": 1
  }'
*/
